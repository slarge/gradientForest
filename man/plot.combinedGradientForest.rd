...
\title{
Plots for \code{combinedGradientForest} objects
}
\description{
Plot method for \code{combinedGradientForest} objects.
}
\usage{
...
\arguments{
  \item{x}{
   ...
   \item{plot.type}{
    ...
    \code{gradientForest} objects are \code{"Overall.Importance"}, \code{"Predictor.Ranges"}, \code{"Predictor.Density"}, \code{"Cumulative.Importance"}
    and \code{"Performance"}. Default \code{"Overall.Importance"}.
  }

   \item{par.args}{arguments to be passed on to be used by \code{\link{par}} according 
      the \code{plot.type} chosen.  See Details for the defaults for each plot type.}
